...
func (x *WordInfo) GetLanguageCode() string {
	if x != nil {
		return x.LanguageCode
	}
	return ""
...
const file_riva_proto_riva_asr_proto_rawDesc = "" +
	"\n" +
	...
	"\x13com.nvidia.riva.asrB\fRivaAsrProtoP\x01Z0github.com/rbright/sotto/proto/gen/go/riva/proto\xf8\x01\x01\xa2\x02\x03NRA\xaa\x02\x0fNvidia.Riva.Asr\xca\x02\x0fNvidia\\Riva\\Asr\xe2\x02\x1bNvidia\\Riva\\Asr\\GPBMetadata\xea\x02\x11Nvidia::Riva::Asrb\x06proto3"
